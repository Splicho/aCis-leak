...
public class Castle
{
	...
	public void spawnSiegeGuardsOrMercenaries()
	{
		...
		{
			// Spawn Guards.
			SpawnManager.getInstance().startSpawnTime("pc_siege_warfare_start", String.valueOf(_castleId), null, null, true);
		...
		// Spawn Guards.
			...
			SpawnManager.getInstance().startSpawnTime("siege_warfare_start", String.valueOf(_castleId), null, null, true);
	}
	...
	public void despawnSiegeGuardsOrMercenaries()
	{
		...
		// Despawn Guards.
		SpawnManager.getInstance().stopSpawnTime("pc_siege_warfare_start", String.valueOf(_castleId), null, null, true);
		SpawnManager.getInstance().stopSpawnTime("siege_warfare_start", String.valueOf(_castleId), null, null, true);
	}
